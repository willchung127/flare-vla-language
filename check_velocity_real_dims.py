"""check_velocity_real_dims.py — verify the cos(v_A, v_B) headline is not
...
The original probe_velocity_and_actions output computed cos over the entire
...
Usage:
    python3 check_velocity_real_dims.py \\
...
def main():
    ...
    print(f"")
    print(f"  The headline 'cos(v_A,v_B) ≈ 0.999' from probe_velocity_and_actions averages")
