"""probe_velocity_and_actions.py — velocity-level and action-chunk-level divergence.

After mechanism_probe_attn localized cross-attention bypass to expert L17
