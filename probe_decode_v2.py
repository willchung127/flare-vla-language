"""probe_decode_v2.py — CORRECTED decodability probe (replaces the broken AUC=1.000 run).
...
with zero variance — leakage, not signal (exactly the artifact EVIDENCE_LEDGER
flagged).
...
USAGE (remote, openpi venv, ~15-25 min GPU + ~15 min CPU):
  ~/flare/openpi/.venv/bin/python ~/flare/probe_decode_v2.py --out-dir ~/flare/results/probe_decode_v2
"""
