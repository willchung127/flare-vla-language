"""analyze_prompt_sweep_strict.py — strict re-score of the 20-prompt sweep.

The default analyze_prompt_sweep.py reports the lenient "Succ%" (goal object placed),
...
This re-score adds, per prompt, the language-compliant metric:
  - LENIENT  : goal object(s) placed              (== old Succ%)
  ...
  - 1st-moved: which object moved first (displacement proxy, same as analyze_prompt_sweep)
...
Usage:  python3 analyze_prompt_sweep_strict.py --out-suffix promptsweep
"""
import argparse
import json
...
from analyze_prompt_sweep import PROMPT_CATEGORIES, CATEGORY_NAMES
