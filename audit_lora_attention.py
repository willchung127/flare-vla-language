#!/usr/bin/env python3
"""audit_lora_attention.py — does D-v2 fine-tuning make pi0 ATTEND/READ/USE language?
...
the assertion the EVIDENCE_LEDGER flagged as a hard gate for any D-lite claim.
...
USAGE (on the 4090 / remote where openpi + checkpoints live):
  python3 audit_lora_attention.py --out-dir ~/flare/results/lora_attention_audit
