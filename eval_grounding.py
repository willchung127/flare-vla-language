#!/usr/bin/env python3
"""eval_grounding.py — language-grounded success, scored PER PROMPT (not the original BDDL goal).

Fixes the fatal metric confound (EVIDENCE_LEDGER §3): eval_lora_behavioral scores `success=bool(done)`
...
USAGE (remote, openpi venv):
  ~/flare/openpi/.venv/bin/python ~/flare/eval_grounding.py \
